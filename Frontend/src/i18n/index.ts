...
const resources = {
  en: {
    translation: {
      ...
      loadingUserDetails: "Loading your account...",
      roleSelectTitle: "Choose how you want to continue",
      roleSelectSubtitle: "Select one role for this session.",
  ...
  hi: {
    translation: {
      ...
      loadingUserDetails: "आपका खाता लोड किया जा रहा है...",
      roleSelectTitle: "चुनें कि आप कैसे जारी रखना चाहते हैं",
      roleSelectSubtitle: "इस सत्र के लिए एक रोल चुनें।",
